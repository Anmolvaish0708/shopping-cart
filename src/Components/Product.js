...
const Product = ({ post }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] ">
      <div>
